...
{
   /**
   * Determines if the $input string is a valid german landline phone number
   ...
   */	
    ...
    */
    ...
    /**
    * Returns true if number is a valid german landline phone number entered without the country code,
    ...
    */
	...
	$data = require('DE_landline_infos_no_country_code.php');
	...
	foreach( $data as $arr) {
      ...
      /**
      * Returns true if number is a valid german landline phone number entered with '+49' as the country code,
      * returns false otherwise.
      *
      * (see proper use of this method in conjunction with other methods in class)
      *
      ...
      */
	  ...
	  $data = require('DE_landline_infos_country_code_+49.php');
	...
	/**
	* Returns true if number is a valid german landline phone number entered with '0049' as the country code,
	* returns false otherwise.
	*
	* (see proper use of this method in conjunction with other methods in class)
	*
	...
	*/
	...
	public function checkInternationalLong(string $cleaned_input): bool 
	    ...
	    $data = require('DE_landline_infos_country_code_0049.php');
